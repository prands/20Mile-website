...
$config['install_lock'] = "";
$config['license_number'] = '4552-0296-5844-7444';
$config['debug'] = "1";
$config['system_folder'] = "dashboard";
$config['doc_url'] = "http://expressionengine.com/user_guide/";
$config['is_system_on'] = "y";
$config['cookie_prefix'] = "";
$config['site_label'] = '20Mile Interactive';
$config['allow_extensions'] = "y";

/* General
-------------------------------------------------------------------*/
$config['site_index'] = "";
$config['site_url'] = "http".((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == "on") ? "s" : "")."://".$_SERVER['HTTP_HOST'];
...
This configuration expect the following tree under /images :
/avatars/uploads
/captchas
/member_photos
/pm_attachments
...
$config['upload_preferences'] = array(
    1 => array(                                                            
        'name'        => 'Main Image Uploads',                          
        'server_path' => $config['server_path'] . '/images/uploads/', 
...
|
*/
$config['encryption_key'] = "7e3b2ad6-c4af-4971-8165-d5b1eca4e315";
