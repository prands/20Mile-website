...
<form class="assets-filedata">
	...
	<?php endif ?>
		...
		<tr>
			...
			<td><input name="date" type="text" data-type="date" <?php if ($file->row_field('date')): ?>data-default-date="<?php echo $this->localize->set_localized_time($file->row_field('date')) * 1000 ?>" value="<?php echo $this->localize->set_human_time($file->row_field('date')) ?>"<?php endif ?> /></td>
		</tr>
		<tr>
