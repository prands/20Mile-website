...
class Extension_builder_super_search_code_pack extends Addon_builder_super_search_code_pack {
	...
	function Extension_builder_super_search_code_pack($name='')
	{
		parent::Addon_builder_super_search_code_pack($name);
	...
	/* END Extension_builder_super_search_code_pack() */
