...
class Super_search_code_pack_extension_base extends Extension_builder_super_search_code_pack
{	
	var $name			= '';
	var $version		= '';
	var $description	= '';
	...
	function Super_search_code_pack_extension_base( $settings = array() )
    {    	
    	parent::Extension_builder_super_search_code_pack('super_search_code_pack');
