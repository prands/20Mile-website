...
class Addon_builder_super_search {
	...
	public function Addon_builder_super_search ($name='')
	{
		//path to this folder
		...
		if (APP_VER < 2.0)
		{
			...
			if (($parent_class == 'Extension_builder_super_search' OR
				 $super_parent_class == 'Extension_builder_super_search') AND
		...
		//--------------------------------------------
		// documentDOM_super_search instantiated, might move this.
		//--------------------------------------------

		if (REQ == 'CP' AND file_exists($this->aob_path . 'document_dom.php'))
		{
			if ( ! class_exists('documentDOM_super_search'))
			{
				require_once $this->aob_path . 'document_dom.php';
			}

			$this->document = new documentDOM_super_search();
		}
	...
	// END Addon_builder_super_search()
