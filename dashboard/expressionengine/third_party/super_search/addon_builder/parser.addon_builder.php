...
if (APP_VER < 2.0)
{
	eval('class Addon_builder_parser_base_super_search extends Template { }');
}
else
{
	eval('class Addon_builder_parser_base_super_search extends EE_Template { }');
}

class Addon_builder_parser_super_search extends Addon_builder_parser_base_super_search
{
	private $old_get = '';
